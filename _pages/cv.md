...
<div class="cv-header">
  ...
  <div class="cv-header__download">
    <a href="#" onclick="document.getElementById('resume-modal').classList.add('active');return false;"><i class="fas fa-download"></i> Download Resume</a>
  </div>
</div>
...
<div id="resume-modal" class="resume-modal" onclick="if(event.target===this)this.classList.remove('active')">
  <div class="resume-modal__inner">
    ...
    <div class="resume-modal__footer">
      <a href="/files/Resume_2026.docx" download><i class="fas fa-download"></i> Download (.docx)</a>
    </div>
  </div>
</div>
